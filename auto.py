...
def startLog():
    print_colorful_log("Sistema de backup automático de SQL by Henry", Fore.CYAN, Style.BRIGHT)
...
try:
    ...
    print_colorful_log("Ocorreu um erro ao conectar-se ao banco de dados:", Fore.RED, Back.BLACK)
    exit(1)
                ...
                if len(rows) > 0:
                    ...
                    for idx in range(len(rows)):
                        ...
                        if idx < len(rows) - 1:
                            ...
                            sql_file.write(";\n\n")
        print_colorful_log("Estrutura do banco de dados e dados exportados com sucesso.", Fore.GREEN)
    except Exception as e:
        print_colorful_log("Ocorreu um erro durante o processo de exportação:", Fore.RED, Back.BLACK)
        print(e)
...
try:
    while True: # loop
        ...
        print_colorful_log("Aguardando o próximo backup... ", Fore.YELLOW)
        time.sleep(DB_CONFIG["backup_interval"]) # Intervalo
finally:
    db.close()